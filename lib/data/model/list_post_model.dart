...
class ListPostModel extends Equatable {
  ...
  ListPostEntity toEntity() => ListPostEntity(id: id, image: image, likes: likes, tags: tags, text: text, publishDate: publishDate, updatedDate: updatedDate, owner: owner);

  @override
  List<Object?> get props => [id, image, likes, tags, text, publishDate, updatedDate, owner];
...
class OwnerModel extends Equatable {
  ...
  OwnerEntity toEntity() => OwnerEntity(id: id, title: title, firstName: firstName, lastName: lastName, picture: picture);
